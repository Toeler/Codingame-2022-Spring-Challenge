	...
	public class StateReader : IStateReader<InitialState, State> {
		...
		private AbstractEntity ReadEntity() {
			...
			if (type == 0) {
				...
				return new Hero(id, new Vector(x, y), shieldLife, isControlled == 1, type == 1);
			}
		}
	}
}
